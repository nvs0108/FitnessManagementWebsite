...
<?php
        ...
        if(isset($_GET['reg'])) {
          echo '<p class="reg">Registration successful! You can now log in.</p>';
        }
        ?> 
...
<header class="header">
    <a href="#" class="logo"> <span>NITS</span>FIT</a>
...
<div class="credit">&copy; <?= date('Y') ?> created by <span>Nitin Vishwakarma</span> | all rights reserved! </div>
